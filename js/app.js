        ...
        <head>
          ...
          <style>
            * { margin: 0; padding: 0; box-sizing: border-box; }
            ...
            @media print{@page{margin-top:2.5cm;margin-bottom:1.5cm;}.header{position:fixed;top:0;left:0;right:0;margin-top:-2.2cm;background:linear-gradient(135deg,#2e7d32,#1a4d1a);color:white;padding:20px;text-align:center;z-index:1000;}.content{margin-top:0;padding-top:2.8cm;}body{margin:0;padding:0;}}
          </style>
        </head>
        <body>
          <div class="container">
